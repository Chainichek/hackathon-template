package ru.babim.template.notification.config;
...
import ru.babim.template.notification.propeties.KafkaConsumerProperties;
...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, NotificationMessage> kafkaListenerContainerFactory(
        ...
        final ConcurrentKafkaListenerContainerFactory<String, NotificationMessage> factory =
